...
//Tier 1 Tank
<item:mynethersdelight:rock_soup>.definition.food = FoodProperties.create(7, 11, false, 1, <item:minecraft:air>, [
    FoodPropertiesPossibleEffect.of(MobEffectInstance.of(<mobeffect:farmersdelight:comfort>, 3600, 0, false, false), 1),
    FoodPropertiesPossibleEffect.of(MobEffectInstance.of(<mobeffect:minecraft:resistance>, 3600, 0, false, false), 1),]);
//Tier 2 Tank
<item:farmersdelight:roasted_mutton_chops>.definition.food = FoodProperties.create(14, 22, false, 1, <item:minecraft:air>, [
    FoodPropertiesPossibleEffect.of(MobEffectInstance.of(<mobeffect:farmersdelight:nourishment>, 6000, 0, false, false), 1),
    FoodPropertiesPossibleEffect.of(MobEffectInstance.of(<mobeffect:arsenal:guarding>, 3600, 0, false, false), 1),]);
...
<item:farmersdelight:honey_glazed_ham>.definition.food = FoodProperties.create(14, 22, false, 1, <item:minecraft:air>, [
    FoodPropertiesPossibleEffect.of(MobEffectInstance.of(<mobeffect:farmersdelight:nourishment>, 6000, 0, false, false), 1),
    FoodPropertiesPossibleEffect.of(MobEffectInstance.of(<mobeffect:spell_power:haste>, 3600, 1, false, false), 1),]);
<item:mynethersdelight:fried_hoglin_chop>.definition.food = FoodProperties.create(12, 22, false, 1, <item:minecraft:air>, [
